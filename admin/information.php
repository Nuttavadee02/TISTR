        ...
        <nav class="navbar navbar-expand-md navbar-dark" style="background:#222255; color:#aaa;">
            <div class="container">
                ...
                <div class="user">
                    ...
                    ?>
                        <center><h6 style="text-transform: uppercase; color:#ffffff">สถานะ :&nbsp;<?php echo $_SESSION["status"]; ?>&nbsp;<i class="fas fa-user-cog" style="font-size: 18px; color: #46F700;"></i>
                        &nbsp;&nbsp;<a href="../php/logout.php" onclick="return confirm('ต้องการออกจากระบบ!');">ออกจากระบบ</a></h6></center>
                    <?php
                    } else {
                    ...
                    <FORM action="http://www.google.com/custom" method="get" target="_blank"">
                        ...
                        <INPUT type="submit" name="sa" VALUE="ค้นหาเพิ่มเติม">
                    </FORM>
                </div>
                </div>
            </div>
