                    ...
                    <div class="form-lo">
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input class="btn btn-primary" style="width: 100%; border-radius: 40px; font-family: TH Sarabun New; font-weight: bold; padding: 14px;" type="submit" value="ตกลง" onclick="return confirm('ต้องการเพิ่มข้อมูล!');">
                            </div>
                        </div>
