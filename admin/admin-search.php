...
if (isset($_POST['cmdSearch'])) {
    $sql .= "WHERE cu_case LIKE '%" . $_POST['txtsearch'] . "%' ";
}

if (isset($_GET['ID'])) {
    $result = $conn->query("DELETE FROM customer WHERE ID=" . $_GET['ID']);
    if ($result) {
        echo "<script type='text/javascript'>";
        echo "alert('ลบข้อมูลสำเร็จ');";
        echo "window.location = 'admin-search.php'; ";
        echo "</script>";
    } else {
        echo "<script type='text/javascript'>";
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="information.php" style="color:lightgray;">คลังข้อมูล</a>
                        </li>
                    </ul>
                </div>
                <div class="user">
                    ...
                    ?>
                        ...
                        <center><a href="../php/logout.php" onclick="return confirm('ต้องการออกจากระบบ!');">Sing out.</a></center>
                    <?php
                    } else {
                        echo "<script type='text/javascript'>";
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table table-hover">
                        <thead class="thead" style="color: #fff; background-color: #007bff; border-color: #a1c5ec;">
                            <th scope="col" nowrap>วันที่ - เวลา ที่สอบถาม</th>
                            <th scope="col" nowrap>ชื่อ-นามสกุล</th>
                            <th scope="col" nowrap>หมายเลขโทรศัพท์</th>
                            <th scope="col" nowrap>ช่องทางการรับข้อมูล</th>
                            <th scope="col" nowrap>เรื่องที่สอบถาม</th>
                            <th scope="col" nowrap>จัดการข้อมูล</th>
                        </thead>
                        <tbody style="background-color: #FFFFFF;">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td scope="col" nowrap style="font-size: 14px;"><a href="admin-search.php?ID=<?= $row['ID'] ?>" onclick="return confirm('ต้องการลบข้อมูล!');">ลบข้อมูล</a></td>
                                </tr>
                            <?php
                            }
